import { Calendar, CalendarRange, CalendarDays, ListChecks, Wallet, type LucideIcon } from 'lucide-react';
import { Button } from '@alsari/ui';

export type VistaAgenda = 'hoy' | 'semana' | 'mes' | 'pendientes' | 'cobros';
