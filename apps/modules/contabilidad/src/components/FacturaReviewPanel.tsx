...
import {
  X, CheckCircle, XCircle, Loader2, ChevronDown, ExternalLink, AlertCircle, Info,
  Building2, UserCheck, Link2, Unlink, Search, Plus, Paperclip, AlertTriangle, Check, Cloud,
} from 'lucide-react';
import type {
  FacturaRecibida, ConfiguracionContabilidad, RolAprobacion, OcrConfianza,
  LineaAsiento, TipoOperacion,
  MetodoPago, TipoPago, EstadoPago, FacturaPago, FacturaIncidencia, ProveedorRegla,
} from '@alsari/types';
import { ESTADO_FACTURA_RECIBIDA_LABEL } from '@alsari/types';
import {
  METODO_PAGO_LABEL, TIPO_PAGO_LABEL, ESTADO_PAGO_LABEL, TIPO_INCIDENCIA_LABEL, DRIVE_ESTADO_LABEL,
  ESTADO_OPERATIVO_DOMICILIADA_LABEL,
} from '@alsari/types';
import {
  avanzarEstadoFacturaConAuditoria, getAprobaciones, updateFacturaRecibida,
  registrarCorreccionOcr, insertAsientoBorrador,
  searchPartidasPresupuesto, crearPagoDesdeFactura, desvincularFacturaDePresupuesto, marcarPagoComoPagado,
  getFacturaPdfUrl, resolveFacturaPdfSource,
  getFacturaPagos, getFacturaIncidencias, uploadJustificante, registrarPagoFactura,
  getJustificanteUrl, resolverIncidenciaFactura, archivarFacturaEnDrive, getFacturaById,
  cambiarSociedadFactura, getReglasByContacto, insertProveedorRegla, type NuevaProveedorRegla,
...
import {
  seleccionarRegla, analizarRegla, reglaDesdeFactura, estadoOperativoFactura, type Sugerencia,
...
const CUENTAS_GASTO: { codigo: string; descripcion: string }[] = [
  ...
  { codigo: '133', descripcion: 'Ajustes por valoración en activos financieros disponibles para la venta' },
  ...
  { codigo: '143', descripcion: 'Provisión por desmantelamiento, retiro o rehabilitación del inmovilizado' },
  ...
  { codigo: '241', descripcion: 'Valores representativos de deuda a largo plazo, empresas del grupo' },
  ...
  { codigo: '244', descripcion: 'Valores representativos de deuda a largo plazo, empresas asociadas' },
  { codigo: '245', descripcion: 'Créditos a largo plazo a empresas asociadas' },
  { codigo: '250', descripcion: 'Inversiones financieras a largo plazo en instrumentos de patrimonio' },
  ...
  { codigo: '293', descripcion: 'Deterioro de valor de participaciones a largo plazo, empresas del grupo' },
  { codigo: '294', descripcion: 'Deterioro de valor de valores de deuda a largo plazo, empresas del grupo' },
  { codigo: '295', descripcion: 'Deterioro de valor de créditos a largo plazo, empresas del grupo' },
  { codigo: '296', descripcion: 'Deterioro de valor de participaciones a largo plazo, empresas asociadas' },
  { codigo: '297', descripcion: 'Deterioro de valor de valores de deuda a largo plazo, empresas asociadas' },
  { codigo: '298', descripcion: 'Deterioro de valor de participaciones a largo plazo' },
  { codigo: '299', descripcion: 'Deterioro de valor de valores representativos de deuda a largo plazo' },
  // ══ GRUPO 3 — Existencias ════════════════════════════════════════════════
  ...
  { codigo: '396', descripcion: 'Deterioro de valor de subproductos, residuos y materiales recuperados' },
  ...
  { codigo: '409', descripcion: 'Proveedores, facturas pendientes de recibir o de formalizar (grupo)' },
  ...
  { codigo: '493', descripcion: 'Deterioro de valor de créditos por operaciones comerciales, empresas del grupo' },
  { codigo: '494', descripcion: 'Deterioro de valor de créditos por operaciones comerciales, empresas asociadas' },
  { codigo: '495', descripcion: 'Deterioro de valor de créditos por operaciones con partes vinculadas' },
  { codigo: '496', descripcion: 'Deterioro de valor de créditos por operaciones comerciales (otros)' },
  ...
  { codigo: '531', descripcion: 'Valores representativos de deuda a corto plazo, empresas del grupo' },
  ...
  { codigo: '534', descripcion: 'Valores representativos de deuda a corto plazo, empresas asociadas' },
  { codigo: '535', descripcion: 'Créditos a corto plazo, empresas asociadas' },
  { codigo: '540', descripcion: 'Inversiones financieras a corto plazo en instrumentos de patrimonio' },
  ...
  { codigo: '554', descripcion: 'Cuenta corriente con uniones temporales de empresas y comunidades de bienes' },
  ...
  { codigo: '575', descripcion: 'Bancos e instituciones de crédito, cuentas de ahorro, moneda extranjera' },
  ...
  { codigo: '581', descripcion: 'Pasivos vinculados con activos no corrientes mantenidos para la venta' },
  { codigo: '590', descripcion: 'Deterioro de valor de participaciones a corto plazo, empresas del grupo' },
  { codigo: '593', descripcion: 'Deterioro de valor de valores de deuda a corto plazo, empresas del grupo' },
  { codigo: '595', descripcion: 'Deterioro de valor de créditos a corto plazo, empresas del grupo' },
  { codigo: '596', descripcion: 'Deterioro de valor de participaciones a corto plazo' },
  { codigo: '597', descripcion: 'Deterioro de valor de valores representativos de deuda a corto plazo' },
  ...
  { codigo: '643', descripcion: 'Retribuciones a largo plazo mediante sistemas de aportación definida' },
  { codigo: '644', descripcion: 'Retribuciones a largo plazo mediante sistemas de prestación definida' },
  ...
  { codigo: '663', descripcion: 'Pérdidas por valoración de instrumentos financieros a valor razonable' },
  ...
  { codigo: '673', descripcion: 'Pérdidas procedentes de participaciones a largo plazo en partes vinculadas' },
  { codigo: '674', descripcion: 'Pérdidas por operaciones con obligaciones propias' },
  { codigo: '675', descripcion: 'Pérdidas procedentes de participaciones en el capital a largo plazo' },
  ...
  { codigo: '696', descripcion: 'Pérdidas por deterioro de participaciones y valores a largo plazo' },
  { codigo: '697', descripcion: 'Pérdidas por deterioro de créditos a largo plazo' },
  { codigo: '698', descripcion: 'Pérdidas por deterioro de participaciones y valores a corto plazo' },
  ...
  { codigo: '713', descripcion: 'Variación de existencias de subproductos, residuos y materiales recuperados' },
  ...
  { codigo: '747', descripcion: 'Otras subvenciones, donaciones y legados trasladados al resultado' },
  ...
  { codigo: '766', descripcion: 'Beneficios en participaciones y valores representativos de deuda' },
  ...
  { codigo: '773', descripcion: 'Beneficios procedentes de participaciones a largo plazo, partes vinculadas' },
  { codigo: '774', descripcion: 'Beneficios por operaciones con obligaciones propias' },
  { codigo: '775', descripcion: 'Subvenciones, donaciones y legados de capital transferidos al resultado' },
  ...
  { codigo: '796', descripcion: 'Reversión del deterioro de participaciones y valores a largo plazo' },
  { codigo: '797', descripcion: 'Reversión del deterioro de créditos a largo plazo' },
  { codigo: '798', descripcion: 'Reversión del deterioro de participaciones y valores a corto plazo' },
  ...
  { codigo: '802', descripcion: 'Transferencia de beneficios en activos financieros disponibles para la venta' },
  { codigo: '810', descripcion: 'Pérdidas actuariales y ajustes por el efecto de límite del activo' },
  ...
  { codigo: '902', descripcion: 'Transferencia de pérdidas en activos financieros disponibles para la venta' },
...
function sugerirCuenta(concepto: string, proveedor: string): string {
  ...
  if (/notari|abogad|asesor|gestor|consultor|honorario|arquitecto|ingenier|aparejador/.test(t)) return '623';
...
function buildLineasAsiento(
  cuentaGasto: string, base: number, cuotaIva: number,
  retencion: number, totalPagar: number,
  tipoOp: string, tivaNum: number,
): LineaAsiento[] {
  ...
  if (tipoOp === 'inversion_sujeto_pasivo' && tivaNum > 0) {
    ...
    lineas.push({ cuenta_codigo: '472', cuenta_descripcion: 'H.P. IVA soportado (ISP)', debe: ivaISP, haber: 0 });
    lineas.push({ cuenta_codigo: '477', cuenta_descripcion: 'H.P. IVA repercutido (ISP)', debe: 0, haber: ivaISP });
  } else if (cuotaIva > 0) {
    lineas.push({ cuenta_codigo: '472', cuenta_descripcion: 'H.P. IVA soportado', debe: cuotaIva, haber: 0 });
  }

  if (retencion > 0)
    lineas.push({ cuenta_codigo: '4751', cuenta_descripcion: 'H.P. retenciones IRPF', debe: 0, haber: retencion });
  lineas.push({ cuenta_codigo: '400', cuenta_descripcion: 'Proveedores', debe: 0, haber: totalPagar });
  return lineas;
}

// ── Auth helpers ──────────────────────────────────────────────────────────────

function detectarRol(email: string | null, config: ConfiguracionContabilidad | null): RolAprobacion | null {
...
function Field({
  label, value, onChange, type = 'text', disabled = false, required = false,
}: {
  ...
  return (
    <div className="group">
      <p className="text-2xs uppercase tracking-widest text-zinc-500 mb-1 leading-none">
        {label}{required && <span className="text-rose-400/70 ml-0.5">*</span>}
      </p>
      <div className={`
        relative rounded-md transition-all duration-150
        ${focused
          ? 'ring-1 ring-white/15 bg-white/[0.04]'
          : 'ring-0 bg-transparent hover:bg-white/[0.02]'
        }
      ...
      `}>
        <input
          ...
          className={`
            w-full h-8 px-2 bg-transparent text-sm font-medium
            focus:outline-none [color-scheme:dark]
            ${isEmpty && !focused ? 'text-zinc-600' : 'text-white'}
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-1">
        <p className="text-2xs uppercase tracking-widest text-zinc-500 leading-none">{label}</p>
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-2xs uppercase tracking-widest text-zinc-600 pb-3">{children}</p>
  );
}
...
function TimelineRow({
  actor, fecha, titulo, detalle, sintetica = false,
}: { actor: string; fecha: string; titulo: string; detalle?: string; sintetica?: boolean }) {
  return (
    <div className="flex gap-3">
      <div className="flex flex-col items-center pt-1">
        <span className={`w-1.5 h-1.5 rounded-full shrink-0 ${sintetica ? 'bg-zinc-600' : 'bg-zinc-400'}`} />
        <span className="w-px flex-1 bg-white/[0.06]" />
      </div>
      <div className="pb-1 min-w-0">
        <p className="text-2xs text-zinc-500">
          <span className="text-zinc-300 font-medium">{actor}</span> · {fecha}
          {sintetica && <span className="text-zinc-600"> · informativo</span>}
        </p>
        <p className="text-xs text-zinc-300">
          {titulo}{detalle ? <span className="text-zinc-500"> · {detalle}</span> : null}
        </p>
      </div>
    </div>
  );
...
function Timeline({ factura, aprobaciones }: { factura: FacturaRecibida; aprobaciones: FacturaAprobacion[] }) {
...
type PagoFormData = { importe: number; fecha: string; metodo: MetodoPago; tipo: TipoPago; file: File | null; comentario: string };

function PagoForm({ soloRegularizacion, saving, onSubmit, onCancel }: {
  ...
  const tipoOptions = (soloRegularizacion
    ? (['regularizacion'] as TipoPago[])
    : (['parcial', 'total', 'anticipo', 'regularizacion'] as TipoPago[])
  ).map(t => ({ value: t, label: TIPO_PAGO_LABEL[t] }));
  const metodoOptions = (['transferencia', 'domiciliacion', 'tarjeta', 'efectivo', 'otro'] as MetodoPago[])
  ...
  return (
    <div className="space-y-3 rounded-lg border border-white/10 bg-white/[0.02] p-3">
      <div className="grid grid-cols-2 gap-2.5">
        ...
        <SelectField label="Método" value={metodo} onChange={v => setMetodo(v as MetodoPago)} options={metodoOptions} />
        <SelectField label="Tipo" value={tipo} onChange={v => setTipo(v as TipoPago)} options={tipoOptions} disabled={soloRegularizacion} />
      </div>

      <div>
        <p className="text-2xs uppercase tracking-widest text-zinc-500 mb-1">Justificante</p>
        <div className="flex items-center gap-2">
          <input ref={fileRef} type="file" accept=".pdf,.jpg,.jpeg,.png" className="hidden"
            onChange={e => setFile(e.target.files?.[0] ?? null)} />
          <button type="button" onClick={() => fileRef.current?.click()}
            className="flex items-center gap-1.5 px-2.5 py-1.5 text-2xs font-medium text-zinc-300 border border-white/10 hover:border-white/20 rounded-md transition-colors">
            <Paperclip size={11} /> {file ? 'Cambiar' : 'Adjuntar'}
          </button>
          {file && <span className="text-2xs text-zinc-400 truncate">{file.name}</span>}
        </div>
        {faltaJustificante && (
          <p className="mt-1 flex items-center gap-1 text-2xs text-amber-400/80">
            <AlertTriangle size={10} /> Transferencia sin justificante (puedes registrar igualmente).
          </p>
        )}
      </div>
      ...
      <div className="flex items-center gap-2 pt-0.5">
        <button onClick={onCancel} disabled={saving}
          className="flex-1 py-2 text-2xs font-medium text-zinc-500 hover:text-zinc-300 border border-white/[0.08] hover:border-white/15 rounded-lg transition-all disabled:opacity-50">
          Cancelar
        </button>
        <button
          onClick={() => onSubmit({ importe: importeNum, fecha, metodo, tipo, file, comentario: comentario.trim() })}
          disabled={!valido}
          className="flex-1 flex items-center justify-center gap-1.5 py-2 text-2xs font-medium text-zinc-950 bg-zinc-100 hover:bg-white rounded-lg transition-colors disabled:opacity-40">
          {saving ? <Loader2 size={12} className="animate-spin" /> : <Check size={12} />} Registrar pago
        </button>
      </div>
    </div>
  );
...
function PagosSection({
  resumen, pagos, incidencias, isPrivateMode, puedeRegistrar, soloRegularizacion,
  puedeResolver, showForm, registrando, onToggleForm, onSubmit, onAbrirJustificante, onResolverIncidencia,
}: {
  resumen: ResumenPago;
  pagos: FacturaPago[];
  ...
  const f = (n: number) => isPrivateMode
    ? '****'
    ...
    <div className="space-y-3">
      ...
      <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-3 space-y-2.5">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-baseline gap-2 min-w-0">
            ...
            <span className="text-2xs text-zinc-500 truncate">de {f(resumen.totalAPagar)}</span>
          </div>
          <span className={`shrink-0 text-2xs font-medium px-2 py-0.5 rounded-full ring-1 ${ESTADO_PAGO_STYLE[resumen.estadoPago]}`}>
            {ESTADO_PAGO_LABEL[resumen.estadoPago]}{resumen.dentroTolerancia ? ' · dentro de tolerancia' : ''}
          </span>
        </div>
        <div className="h-1.5 rounded-full bg-white/[0.06] overflow-hidden">
          <div className={`h-full rounded-full transition-all ${resumen.estadoPago === 'sobrepagada' ? 'bg-rose-500/70' : 'bg-emerald-500/60'}`}
            style={{ width: `${pct}%` }} />
        </div>
        <div className="flex items-center justify-between text-2xs text-zinc-500">
          <span>Pendiente:{' '}
            <span className={resumen.pendiente > 0 ? 'text-amber-400' : resumen.pendiente < 0 ? 'text-rose-400' : 'text-emerald-400'}>
              {f(resumen.pendiente)}
            </span>
          </span>
          <span>{pct}%</span>
      ...
      {pagos.length > 0 && (
        <div className="space-y-1.5">
          {pagos.map(p => (
            <div key={p.id} className="flex items-center gap-2 rounded-md border border-white/[0.05] bg-white/[0.015] px-2.5 py-1.5">
              <span className="text-2xs text-zinc-500 w-12 shrink-0">{fmtFechaCorta(p.fecha_pago)}</span>
              <span className={`text-sm font-medium ${p.importe < 0 ? 'text-rose-300' : 'text-white'}`}>{f(p.importe)}</span>
              <span className="text-2xs text-zinc-500 truncate">· {METODO_PAGO_LABEL[p.metodo_pago]} · {TIPO_PAGO_LABEL[p.tipo_pago]}</span>
              {p.justificante_storage_path && (
                <button onClick={() => onAbrirJustificante(p.justificante_storage_path!)} title="Ver justificante"
                  className="ml-auto p-1 text-zinc-500 hover:text-zinc-200 rounded transition-colors shrink-0">
                  <Paperclip size={12} />
                </button>
              )}
            </div>
      ...
      {incidenciasAbiertas.length > 0 && (
        <div className="space-y-1.5">
          {incidenciasAbiertas.map(i => (
            <div key={i.id} className="flex items-start gap-2 rounded-md border border-rose-500/15 bg-rose-500/[0.06] px-2.5 py-1.5">
              <AlertTriangle size={12} className="text-rose-400 mt-0.5 shrink-0" />
              <div className="min-w-0 flex-1">
                <p className="text-2xs font-medium text-rose-300">{TIPO_INCIDENCIA_LABEL[i.tipo]}</p>
                {i.descripcion && <p className="text-2xs text-zinc-400 leading-snug">{i.descripcion}</p>}
              </div>
              {puedeResolver && (
                <button onClick={() => onResolverIncidencia(i.id)}
                  className="text-2xs font-medium text-zinc-400 hover:text-emerald-400 transition-colors shrink-0">
                  Resolver
                </button>
              )}
            </div>
      ...
      {puedeRegistrar && (showForm ? (
        <PagoForm soloRegularizacion={soloRegularizacion} saving={registrando} onSubmit={onSubmit} onCancel={() => onToggleForm(false)} />
      ) : (
        <button onClick={() => onToggleForm(true)}
          className="w-full flex items-center justify-center gap-1.5 py-2 text-2xs font-medium text-zinc-300 border border-dashed border-white/10 hover:border-white/20 hover:bg-white/[0.02] rounded-lg transition-all">
...
export function FacturaReviewPanel({
  factura, config, userEmail, isPrivateMode, sociedades, onClose, onUpdate,
}: Props) {
  ...
  const refreshAprobaciones = useCallback(() => {
    getAprobaciones(factura.id).then(setAprobaciones).catch(() => { /* no crítico */ });
  }, [factura.id]);
  useEffect(() => { refreshAprobaciones(); }, [refreshAprobaciones]);

  // Pagos + incidencias (libro de tesorería). Se recargan tras cada acción.
  const refreshPagos = useCallback(() => {
    getFacturaPagos(factura.id).then(setPagos).catch(() => { /* no crítico */ });
    getFacturaIncidencias(factura.id).then(setIncidencias).catch(() => { /* no crítico */ });
  }, [factura.id]);
  useEffect(() => { refreshPagos(); }, [refreshPagos]);

  // PR E — Reglas del proveedor (por contacto). Se usan para SUGERIR (no aplica nada solo).
  useEffect(() => {
    if (!factura.contacto_id) { setReglas([]); return; }
    getReglasByContacto(factura.contacto_id).then(setReglas).catch(() => setReglas([]));
  }, [factura.contacto_id]);
  ...
  useEffect(() => {
    ...
    searchPartidasPresupuesto()
      .then(rows => { setPartidas(rows); setLoadingPartidas(false); })
  ...
  const grouped = useMemo(() => {
    const map = new Map<string, { key: string; capitulo: string; presupuesto: string; partidas: PartidaParaVincular[] }>();
    for (const p of partidasFiltered) {
      const key = `${p.presupuesto_id}__${p.capitulo_id}`;
      if (!map.has(key)) map.set(key, { key, capitulo: p.capitulo_nombre, presupuesto: p.presupuesto_nombre, partidas: [] });
  ...
  const totalAPagarFactura = factura.total_a_pagar || calcularTotalAPagar(factura.total, factura.retencion_importe);
  const resumenPago = calcularEstadoPago(totalAPagarFactura, pagos.map(p => p.importe));
  const puedeRegistrarPago = (test || rol === 'alicia')
    && (factura.estado === 'pendiente_pago' || factura.estado === 'pagada');
  const soloRegularizacion = factura.estado === 'pagada';
  const mostrarPagos = factura.estado === 'pendiente_pago' || factura.estado === 'pagada' || pagos.length > 0;
  ...
  const reglaProveedor = useMemo(
    () => seleccionarRegla(reglas, factura.contacto_id, factura.sociedad_id_ref, factura.sociedad_validada),
  ...
  const fmtSugValor = (s: Sugerencia): string => {
    ...
    if (s.campo === 'tipo_operacion')  return TIPOS_OPERACION.find(o => o.value === s.valor)?.label ?? String(s.valor);
  ...
  const asientoLineas = useMemo(
    () => buildLineasAsiento(form.cuenta_gasto, base, cuotaIva, ret, totalPagar, form.tipo_operacion, tivaNum),
  ...
  async function registrarCorrecciones(f: DraftForm) {
    ...
    const campos: (keyof DraftForm)[] = [
      ...
      'fecha_vencimiento', 'base_imponible', 'tipo_iva', 'cuota_iva',
      'retencion_pct', 'retencion_importe', 'total', 'concepto',
    ];
    await Promise.allSettled(campos.map(campo => {
  ...
  async function handleAprobar() {
    ...
    if (sociedadPendiente) {
      setError('La sociedad receptora no está validada. Reasigna la sociedad correcta antes de dar el visto bueno.');
      return;
    }
    setSaving(true);
    setError(null);
    try {
      ...
      const comentario = accion === 'valida' && total > umbral
        ? 'Supera el umbral: pasa a revisión de Javi.'
        : null;
      const actualizada = await avanzarEstadoFacturaConAuditoria({ facturaId: factura.id, accion, comentario });
  ...
  async function handlePagar() {
    ...
    setError(null);
    try {
      const actualizada = await avanzarEstadoFacturaConAuditoria({ facturaId: factura.id, accion: 'marca_pagada' });
  ...
  async function handleConfirmarRechazo() {
    ...
    try {
      ...
      const actualizada = await avanzarEstadoFacturaConAuditoria({
        facturaId: factura.id, accion: 'rechaza', motivoRechazo: motivo, comentario: motivo,
      });
  ...
  async function handleRegistrarPago(a: PagoFormData) {
    ...
    try {
      ...
      const r = await registrarPagoFactura({
        pagoId, facturaId: factura.id, importe: a.importe, fechaPago: a.fecha,
        metodoPago: a.metodo, tipoPago: a.tipo, justificante: just, comentario: a.comentario || null,
      });
      if (r.transiciona) { onUpdate({ ...factura, estado: 'pagada' }); void handleArchivarDrive(); }
  ...
  async function handleArchivarDrive() {
    ...
    if (sociedadPendiente) {
      setError('No se archiva en Drive: la sociedad receptora no está validada. Reasigna la sociedad correcta primero.');
      return;
    }
  ...
  function aplicarSugerencia(s: Sugerencia) {
    switch (s.campo) {
      case 'cuenta_gasto':   set('cuenta_gasto')(String(s.valor)); break;
      case 'concepto':       set('concepto')(String(s.valor)); break;
      case 'tipo_operacion': handleTipoOpChange(String(s.valor)); break;
      case 'tipo_iva': {
        const tiva = Number(s.valor) || 0;
        const b = parseFloat(form.base_imponible) || 0;
        const sinI = form.tipo_operacion !== 'normal';
        setForm(f => ({ ...f, tipo_iva: String(tiva), cuota_iva: sinI ? '0' : String(+(b * tiva / 100).toFixed(2)) }));
        break;
      }
      case 'retencion_pct': {
        const rpct = Number(s.valor) || 0;
        setForm(f => ({ ...f, retencion_pct: String(rpct), retencion_importe: String(+(base * rpct / 100).toFixed(2)) }));
        break;
      }
      case 'es_domiciliada': void handleToggleDomiciliada(true); return; // ya persiste por su cuenta
    }
  ...
  async function handleToggleDomiciliada(next: boolean) {
    ...
    setError(null);
    try {
      const patch = { es_domiciliada: next, ...(reglaProveedor ? { regla_aplicada_id: reglaProveedor.id } : {}) };
  ...
  async function handleCrearReglaDesdeFactura() {
    if (!factura.contacto_id) { setError('La factura no tiene proveedor (contacto) asociado.'); return; }
    setCreandoRegla(true); setReglaInfo(null); setError(null);
    try {
      const draft = reglaDesdeFactura(facturaView, factura.contacto_id, pagos[0]?.metodo_pago ?? null) as NuevaProveedorRegla;
      const nueva = await insertProveedorRegla(draft);
      setReglas(rs => [nueva, ...rs]);
      setReglaInfo('Regla creada desde esta factura. Ajústala en Contactos › Reglas de facturación.');
    } catch (e) {
  ...
  const ivaISPEfectivo = form.tipo_operacion === 'inversion_sujeto_pasivo'
    ? +(base * tivaNum / 100).toFixed(2)
    : null;
    ...
    <div className="flex flex-col h-full bg-zinc-900">
      ...
      <div className="px-6 pt-5 pb-4 border-b border-white/[0.06] shrink-0">
        <div className="flex items-start justify-between gap-3">
          ...
          {/* Identidad + importe */}
          <div className="min-w-0 flex-1">
            <p className="text-2xs uppercase tracking-widest text-zinc-600 mb-1 font-mono">
              {factura.proveedor_nif ?? '—'}
            </p>
            <h2 className="text-base font-semibold text-white leading-snug mb-3 truncate">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <span className={`inline-flex items-center text-2xs font-medium px-2 py-0.5 rounded-md ${ESTADO_COLOR[factura.estado]}`}>
            ...
            <div className="flex items-center gap-3 mt-2 flex-wrap">
              ...
              {factura.contacto_id && (
                <span className="inline-flex items-center gap-1 text-2xs text-emerald-500/70">
          ...
          <div className="flex items-center gap-1.5 shrink-0 -mt-0.5">
            {resolveFacturaPdfSource(factura).kind !== 'none' && (
              <button
                ...
                className="p-1.5 text-zinc-600 hover:text-zinc-300 transition-colors rounded-md hover:bg-white/5 disabled:opacity-50"
              >
                {abriendoPdf ? <Loader2 size={14} className="animate-spin" /> : <ExternalLink size={14} />}
              </button>
            )}
            <button
              onClick={onClose}
      ...
      {/* ── Error banner ── */}
      {error && (
        <div className="mx-5 mt-4 flex items-start gap-2.5 bg-rose-500/8 border border-rose-500/15 rounded-lg px-3.5 py-2.5 shrink-0">
          <AlertCircle size={13} className="text-rose-400 mt-0.5 shrink-0" />
          <p className="text-xs text-rose-300/90 leading-relaxed flex-1">{error}</p>
          <button onClick={() => setError(null)} className="text-rose-500/60 hover:text-rose-400 shrink-0 transition-colors">
            <X size={11} />
          </button>
        </div>
      )}
      ...
      <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-4">
            <Field label="Nombre" value={form.proveedor_nombre} onChange={set('proveedor_nombre')}
              required disabled={isReadOnly} />
            <Field label="NIF / CIF" value={form.proveedor_nif} onChange={set('proveedor_nif')}
              disabled={isReadOnly} />
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between gap-3 rounded-lg border border-white/[0.06] bg-white/[0.02] px-3.5 py-3">
            <div className="min-w-0">
              <p className="text-2xs uppercase tracking-widest text-zinc-600 mb-1">Vinculada</p>
              {factura.sociedad_id_ref ? (
                <>
                  ...
                  {cifVinculada && <p className="text-2xs text-zinc-500 font-mono mt-1">{cifVinculada}</p>}
                </>
              ) : (
            ...
            {sociedadPendiente ? (
              <span className="inline-flex items-center gap-1 text-2xs text-amber-400/90 shrink-0">
                <AlertTriangle size={11} /> Pendiente
              </span>
            ) : (
              <span className="inline-flex items-center gap-1 text-2xs text-emerald-400/80 shrink-0">
          ...
          <div className="flex items-start gap-2 text-2xs text-zinc-500 px-1">
              ...
              {factura.receptor_nombre_ocr ? (
                <>
                  ...
                  {factura.receptor_nif_ocr && (
                    <span className="ml-1 font-mono text-zinc-400">({factura.receptor_nif_ocr})</span>
                  )}
                </>
              ) : (
          ...
          {nifMismatch && (
            <div className="flex items-start gap-2.5 bg-amber-500/8 border border-amber-500/20 rounded-lg px-3 py-2.5">
              ...
              <p className="text-2xs text-amber-300/90 leading-relaxed">
                La sociedad vinculada no coincide con el receptor detectado por OCR.
                Revisa y reasigna la sociedad correcta antes de dar el visto bueno.
              </p>
            </div>
          )}
          ...
          {sociedades && sociedades.length > 0 && !isReadOnly && (
            <div className="space-y-2">
              <SelectField
                ...
                options={sociedades.map(s => ({ value: s.id, label: s.cif ? `${s.nombre} · ${s.cif}` : s.nombre }))}
              />
              {sociedadSel && sociedadSel !== factura.sociedad_id_ref && (
                <button
                  onClick={handleCambiarSociedad}
                  disabled={cambiandoSociedad}
                  className="w-full inline-flex items-center justify-center gap-2 bg-zinc-100 text-zinc-950 hover:bg-zinc-200 disabled:opacity-50 px-3 py-2 rounded-md text-xs font-medium transition-colors"
                >
                  {cambiandoSociedad ? <Loader2 size={13} className="animate-spin" /> : <Building2 size={13} />}
          ...
          <div className="flex items-center gap-1.5 text-2xs text-zinc-600 px-1">
            <Cloud size={11} className="shrink-0" />
            <span className="font-mono truncate">{drivePreview}</span>
          </div>
        </div>
        ...
        {factura.contacto_id && (
          <>
            <div className="space-y-3">
              <div className="flex items-center justify-between gap-2">
                ...
                {!isReadOnly && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-2xs text-zinc-400 hover:text-zinc-100 hover:bg-white/5 px-2 py-1 rounded-md transition-colors disabled:opacity-50"
                  >
                    {creandoRegla ? <Loader2 size={11} className="animate-spin" /> : <Plus size={11} />}
              ...
              {reglaInfo && (
                <div className="flex items-start gap-2 bg-emerald-500/8 border border-emerald-500/15 rounded-lg px-3 py-2">
                  <Check size={12} className="text-emerald-400 mt-0.5 shrink-0" />
                  <p className="text-2xs text-emerald-300/90 leading-relaxed">{reglaInfo}</p>
                </div>
              )}
              ...
              {analisisRegla && analisisRegla.sugerencias.length > 0 && (
                <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-3 space-y-2.5">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-2xs uppercase tracking-widest text-zinc-500">Sugerencias del proveedor</span>
                    {!isReadOnly && analisisRegla.sugerencias.some(s => !s.yaAplicado) && (
                      <button
                        onClick={aplicarTodasSugerencias}
                        className="text-2xs font-medium text-zinc-950 bg-zinc-100 hover:bg-zinc-200 px-2 py-1 rounded-md transition-colors"
                      >
                        Aplicar todo
                      </button>
                    )}
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {analisisRegla.sugerencias.map(s => (
                      <button
                        ...
                        className={`inline-flex items-center gap-1 text-2xs px-2 py-1 rounded-md border transition-colors ${
                          s.yaAplicado
                            ? 'border-emerald-500/20 text-emerald-400/70 cursor-default'
                  ...
                  {analisisRegla.partidaSugerida && (
                    <p className="text-2xs text-zinc-500">Partida presupuestaria habitual sugerida — vincúlala desde la sección de presupuesto.</p>
                  )}
                  {analisisRegla.metodoPagoDefault && (
                    <p className="text-2xs text-zinc-500">Método de pago habitual: {METODO_PAGO_LABEL[analisisRegla.metodoPagoDefault]}.</p>
                  )}
                </div>
              )}
              ...
              {analisisRegla?.importeFueraRango && (
                <div className="flex items-start gap-2.5 bg-amber-500/8 border border-amber-500/20 rounded-lg px-3 py-2.5">
                  <AlertTriangle size={13} className="text-amber-400 mt-0.5 shrink-0" />
                  <p className="text-2xs text-amber-300/90 leading-relaxed">
                    Importe fuera de lo habitual: {fmt(analisisRegla.importeFueraRango.actual)} vs habitual{' '}
                    {fmt(analisisRegla.importeFueraRango.habitual)} (tolerancia ±{analisisRegla.importeFueraRango.toleranciaPct}%,
                    desviación {analisisRegla.importeFueraRango.desviacionPct}%).
                  </p>
                </div>
              )}

              {/* Toggle domiciliada (disponible aunque no haya regla) */}
              <label className={`flex items-center justify-between gap-3 rounded-lg border border-white/[0.06] bg-white/[0.02] px-3.5 py-2.5 ${isReadOnly ? 'opacity-60' : 'cursor-pointer'}`}>
                <span className="min-w-0">
                  <span className="text-xs text-zinc-200 flex items-center gap-1.5">
                    <Cloud size={12} className="text-zinc-500 shrink-0" /> Factura domiciliada
                  </span>
                  <span className="block text-2xs text-zinc-500 mt-0.5">Se carga en banco — no requiere transferencia manual.</span>
                </span>
                <input
                  type="checkbox"
                  checked={form.es_domiciliada}
                  disabled={isReadOnly}
                  onChange={e => { void handleToggleDomiciliada(e.target.checked); }}
              ...
              {form.es_domiciliada && subEstadoDomiciliada && (
                <div className="flex items-start gap-2 text-2xs text-zinc-500 px-1">
                  ...
                  <span>
                    Estado operativo: <span className="text-zinc-300">{ESTADO_OPERATIVO_DOMICILIADA_LABEL[subEstadoDomiciliada]}</span>.
                    {subEstadoDomiciliada === 'pendiente_cargo' && ' Espera el cargo bancario; al aparecer, registra el pago con método “Domiciliación”.'}
                    {subEstadoDomiciliada === 'cargada_sin_justificante' && ' Adjunta el justificante del cargo bancario.'}
                  </span>
                </div>
              )}
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-x-4 gap-y-4">
            <Field label="Nº factura" value={form.numero_factura} onChange={set('numero_factura')}
              disabled={isReadOnly} />
            <Field label="Fecha emisión" value={form.fecha_factura} onChange={set('fecha_factura')}
              type="date" required disabled={isReadOnly} />
            <Field label="Vencimiento" value={form.fecha_vencimiento} onChange={set('fecha_vencimiento')}
              type="date" disabled={isReadOnly} />
          </div>
          <Field label="Concepto" value={form.concepto} onChange={set('concepto')}
            disabled={isReadOnly} />
        </div>
        ...
        <div className="space-y-4">
          ...
          {form.tipo_operacion === 'inversion_sujeto_pasivo' && (
            <div className="flex items-start gap-2.5 bg-amber-500/6 border border-amber-500/15 rounded-lg px-3 py-2.5">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-2xs text-amber-400/70 leading-relaxed">
                  El proveedor no carga IVA en la factura. Tú debes auto-liquidarlo al {tivaNum}%
                  {ivaISPEfectivo !== null && ivaISPEfectivo > 0 && ` — importe: ${fmt(ivaISPEfectivo)}`}.
          ...
          {form.tipo_operacion === 'suplido' && (
            <div className="flex items-start gap-2.5 bg-zinc-500/6 border border-white/[0.06] rounded-lg px-3 py-2.5">
              <Info size={12} className="text-zinc-500 mt-0.5 shrink-0" />
              <p className="text-2xs text-zinc-500 leading-relaxed">
                Suplido: gasto pagado por cuenta del cliente, no sujeto a IVA ni deducible como gasto propio.
              </p>
            </div>
          )}

          <div className="grid grid-cols-3 gap-x-4 gap-y-4">
            <Field label="Base imponible" value={form.base_imponible} onChange={v => {
              set('base_imponible')(v);
              const b = parseFloat(v) || 0;
              const tiva = parseFloat(form.tipo_iva) || 0;
              const sinI = form.tipo_operacion !== 'normal';
              if (!sinI)
                setForm(f => ({ ...f, base_imponible: v, cuota_iva: String(+(b * tiva / 100).toFixed(2)) }));
            ...
            <Field label="Cuota IVA" value={form.cuota_iva} onChange={set('cuota_iva')}
              type="number"
              disabled={isReadOnly || form.tipo_operacion === 'inversion_sujeto_pasivo'
                || form.tipo_operacion === 'exenta' || form.tipo_operacion === 'no_sujeta'
                || form.tipo_operacion === 'suplido'} />

            <Field label="Retención %" value={form.retencion_pct} onChange={v => {
              const rpct = parseFloat(v) || 0;
              set('retencion_pct')(v);
              set('retencion_importe')(String(+(base * rpct / 100).toFixed(2)));
            }} type="number" disabled={isReadOnly} />
            <Field label="Retención €" value={form.retencion_importe} onChange={set('retencion_importe')}
              type="number" disabled={isReadOnly} />
            <Field label="Total factura" value={form.total} onChange={set('total')}
              type="number" required disabled={isReadOnly} />
          </div>
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <span className="text-sm font-semibold text-white tabular-nums">{fmt(totalPagar)}</span>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <SelectField
            ...
            options={CUENTAS_GASTO.map(cc => ({ value: cc.codigo, label: `${cc.codigo} — ${cc.descripcion}` }))}
            disabled={isReadOnly}
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-white/[0.06]">
                <th className="text-left pb-2 text-2xs uppercase tracking-widest text-zinc-600 font-normal">Cuenta</th>
                <th className="text-right pb-2 text-2xs uppercase tracking-widest text-zinc-600 font-normal w-20">Debe</th>
                <th className="text-right pb-2 text-2xs uppercase tracking-widest text-zinc-600 font-normal w-20">Haber</th>
              </tr>
            </thead>
            <tbody>
              {asientoLineas.map((l, i) => (
                <tr key={i} className="border-b border-white/[0.04] last:border-0">
                  <td className="py-2.5">
                    <span className="font-mono text-zinc-300 text-xs">{l.cuenta_codigo}</span>
                    <span className="text-zinc-500 ml-2">{l.cuenta_descripcion}</span>
                  </td>
          ...
          {!isReadOnly && (
            <p className="text-2xs text-zinc-700">Se creará en Diario Borrador al dar visto bueno.</p>
          )}
        </div>
        ...
        <div className="space-y-3">
          ...
          {(partidaVinculada ?? factura.presupuesto_pago_id) ? (
            <div className="flex items-center gap-3">
              <div className="flex-1 flex items-center gap-2 px-3 py-2.5 rounded-lg bg-blue-500/8 border border-blue-500/15">
              ...
              <button
                ...
                className="p-2 text-zinc-600 hover:text-rose-400 transition-colors rounded-md hover:bg-rose-500/10"
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg border border-dashed border-white/[0.1] text-xs font-medium text-zinc-500 hover:text-blue-400 hover:border-blue-500/30 hover:bg-blue-500/5 transition-all"
            >
              ...
              <div className="w-full max-w-lg bg-zinc-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
                <div className="px-5 py-4 border-b border-white/[0.06] flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-semibold text-white">Enfrentar a partida de presupuesto</p>
                    <p className="text-xs text-zinc-500 truncate">
                      {factura.proveedor_nombre} · {fmt(factura.total_a_pagar)}
                      {' · '}Se creará un pago en la partida seleccionada
                    </p>
                  </div>
                  <button onClick={() => { setShowVincular(false); setQueryPartidas(''); setExpandedGroups(new Set()); }} className="p-1 text-zinc-600 hover:text-white transition-colors">
                    <X size={14} />
                  </button>
                </div>
                <div className="px-4 py-3 border-b border-white/[0.04]">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-8 pr-4 py-2 bg-zinc-800/60 border border-white/[0.06] rounded-xl text-sm text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-blue-500/40 transition-all"
                      autoFocus
                    />
                  </div>
                </div>
                <div className="overflow-y-auto max-h-72">
                  {loadingPartidas ? (
                    ...
                    <div className="py-10 text-center text-zinc-600 text-sm">Sin partidas disponibles</div>
                  ) : grouped.map(group => (
                    <div key={group.key} className="border-b border-white/[0.04] last:border-0">
                      ...
                      >
                        <ChevronDown
                          size={12}
                          className={`text-zinc-500 shrink-0 transition-transform duration-150 ${expandedGroups.has(group.key) ? '' : '-rotate-90'}`}
                        />
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-semibold text-zinc-200">{group.capitulo}</p>
                          <p className="text-2xs text-zinc-600 truncate">
                            {group.presupuesto} · {group.partidas.length} partida{group.partidas.length !== 1 ? 's' : ''}
                          </p>
                        </div>
                      </button>
                      {/* Partidas expandidas */}
                        ...
                        <div className="border-t border-white/[0.04]">
                          {group.partidas.map(p => (
                            <button
                              ...
                              className="w-full flex items-center gap-3 pl-11 pr-5 py-3 text-left border-b border-white/[0.03] last:border-0 hover:bg-blue-500/5 hover:border-blue-500/10 transition-colors cursor-pointer disabled:opacity-50"
                            >
                              <div className="flex-1 min-w-0">
                                <p className="text-sm font-medium text-zinc-200 truncate">{p.descripcion}</p>
                                {p.proveedor_esperado && (
                                  <p className="text-2xs text-zinc-600 truncate">{p.proveedor_esperado}</p>
                                )}
                              </div>
                              <div className="shrink-0 text-right">
                                <p className="text-sm font-semibold text-white">{fmt(p.importe_presupuestado)}</p>
                                {p.tipo_iva > 0 && (
                                  <p className="text-2xs text-amber-400/70">IVA {p.tipo_iva}%</p>
                                )}
                              </div>
                              {vincularando
                                ? <Loader2 size={13} className="animate-spin text-blue-400 shrink-0" />
                                : <ChevronDown size={13} className="text-zinc-600 shrink-0 -rotate-90" />
                              }
                            </button>
                          ))}
                        </div>
        ...
        <div className="space-y-3">
          ...
          <textarea
            ...
            disabled={isReadOnly}
            rows={2}
            className="w-full bg-transparent text-sm text-white placeholder:text-zinc-700 focus:outline-none resize-none disabled:opacity-40 transition-all rounded-md px-2 py-1.5 hover:bg-white/[0.02] focus:bg-white/[0.03] focus:ring-1 focus:ring-white/10"
            placeholder="Observaciones, instrucciones de pago…"
          />
        </div>

        {/* Motivo de rechazo */}
        {factura.estado === 'rechazada' && factura.notas && factura.notas.includes('[RECHAZADA') && (
          <>
            <hr className="border-white/[0.06]" />
            <div className="space-y-2">
              <p className="text-2xs uppercase tracking-widest text-rose-500/60">Motivo del rechazo</p>
              <p className="text-sm text-rose-300/80 leading-relaxed">
                {factura.notas.split('\n').find(l => l.startsWith('[RECHAZADA'))?.replace(/\[RECHAZADA en [^\]]+\]\s*/, '') ?? '—'}
              </p>
            </div>
          </>
        )}
        ...
        {mostrarPagos && (
          <div className="space-y-3">
            ...
            <PagosSection
              ...
              onSubmit={(a) => { void handleRegistrarPago(a); }}
              onAbrirJustificante={(p) => { void handleAbrirJustificante(p); }}
              onResolverIncidencia={(id) => { void handleResolverIncidencia(id); }}
            />
          </div>
        )}

        {/* Archivo en Google Drive (PR D) */}
        {(factura.estado === 'pagada' || factura.drive_estado !== 'no_archivado' || hayDocsDrive) && (
          <div className="space-y-3">
            ...
            <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-3 flex items-center gap-3">
              <Cloud size={16} className={
                factura.drive_estado === 'sincronizado' ? 'text-emerald-400'
                  : factura.drive_estado === 'error' ? 'text-rose-400' : 'text-zinc-500'
              } />
              <div className="flex-1 min-w-0">
                <p className="text-xs font-medium text-zinc-200">
                  {archivandoDrive ? 'Archivando…' : !hayDocsDrive ? 'Sin documentos para archivar' : DRIVE_ESTADO_LABEL[factura.drive_estado]}
                </p>
                {factura.drive_estado === 'error' && factura.drive_error
                  ? <p className="text-2xs text-rose-400/80 truncate">{factura.drive_error}</p>
                  : <p className="text-2xs text-zinc-600">Copia documental (factura + justificantes). El original sigue en la app.</p>}
              </div>
              {factura.drive_folder_id && (
                <button
                  onClick={() => window.open(`https://drive.google.com/drive/folders/${factura.drive_folder_id}`, '_blank', 'noopener,noreferrer')}
                  title="Abrir expediente en Drive"
                  className="p-1.5 text-zinc-500 hover:text-blue-400 rounded-md hover:bg-white/5 transition-colors shrink-0"
                >
              ...
              {hayDocsDrive && (
                <button
                  onClick={() => { void handleArchivarDrive(); }}
                  disabled={archivandoDrive}
                  className="flex items-center gap-1.5 px-2.5 py-1.5 text-2xs font-medium text-zinc-300 border border-white/10 hover:border-white/20 rounded-md transition-colors disabled:opacity-50 shrink-0"
                >
                  {archivandoDrive ? <Loader2 size={12} className="animate-spin" /> : <Cloud size={12} />}
                  {factura.drive_estado === 'error' ? 'Reintentar' : factura.drive_estado === 'sincronizado' ? 'Re-archivar' : 'Enviar a Drive'}
                </button>
              )}
            </div>
          </div>
      ...
      {/* ── Actions bar ── */}
      {!isReadOnly && (
        <div className="px-5 py-4 border-t border-white/[0.06] shrink-0 bg-zinc-900">
          ...
          {rechazando ? (
            <div className="space-y-3">
              ...
              <textarea
                ...
                className="w-full bg-white/[0.03] border border-rose-500/20 rounded-lg px-3 py-2 text-sm text-white placeholder:text-zinc-600 focus:outline-none focus:border-rose-500/40 transition-colors resize-none"
              />
              <div className="flex items-center gap-2">
                <button
                  onClick={() => { setRechazando(false); setMotivoRechazo(''); }}
                  disabled={saving}
                  className="flex-1 py-2 text-xs font-medium text-zinc-500 hover:text-zinc-300 border border-white/[0.08] hover:border-white/15 rounded-lg transition-all disabled:opacity-50"
                >
                  Cancelar
                </button>
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 py-2 text-xs font-medium text-white bg-rose-600/80 hover:bg-rose-600 rounded-lg transition-colors disabled:opacity-50"
                >
            ...
            <div className="flex items-center gap-2">
              {puedeRechazar && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-zinc-500 hover:text-rose-400 border border-white/[0.08] hover:border-rose-500/20 rounded-lg transition-all"
                >
                  <XCircle size={12} />
                  Rechazar
                </button>
              ...
              <div className="ml-auto flex items-center gap-2">
                {puedeAprobar && (
                  <button
                    ...
                    disabled={saving}
                    className="flex items-center gap-1.5 px-5 py-2 text-xs font-medium bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg transition-colors disabled:opacity-50"
                  >
                ...
                {puedePagar && (
                  <button
                    ...
                    disabled={saving}
                    className="flex items-center gap-1.5 px-5 py-2 text-xs font-medium bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-colors disabled:opacity-50"
                  >
                    {saving ? <Loader2 size={12} className="animate-spin" /> : <CheckCircle size={12} />}
                    Marcar como pagada
                  </button>
