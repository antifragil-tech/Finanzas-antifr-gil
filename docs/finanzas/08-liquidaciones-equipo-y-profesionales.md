...
- En ese backlog la letra **B** está asignada a *F-Op B — Rentabilidad Clínica*, y el contenido funcional de este módulo corresponde a **F-Op C2** (coste de personas: asalariados y autónomos por sesión) más el caso de **recepción compartida** de **F-Op C1** (reglas de imputación).
...
*Diseño documental de FOP-B1. No modifica código productivo, SQL, tipos ni UI. Requiere validación de Fernando antes de abrir implementación.*
